...
})(["background-color:", ";padding:", ";box-shadow:0 1px 2px 0 ", ";border:solid 2px ", ";border-radius:", ";outline:solid 1px white;outline-offset:", ";overflow:auto;&:hover{cursor:pointer;border-color:", ";outline-offset:-3px;}> *:not(:last-child){margin-bottom:12px;}"], function (_ref) {
...
var Option = function Option(_ref8) {
  var items = _ref8.items,
      ...
      isCurrentCombination = _ref8.isCurrentCombination,
      pickerType = _ref8.pickerType,
      isPersonalItemPresent = _ref8.isPersonalItemPresent,
      airlines = _ref8.airlines,
      shouldShowRecheckNote = _ref8.shouldShowRecheckNote,
      prioBoardingLinkHandler = _ref8.prioBoardingLinkHandler;
  ...
  }, _ref9)), priorityAirlines.length > 0 && React.createElement(_PriorityBoardingInfo.default, {
    airlines: priorityAirlines,
    prioBoardingLinkHandler: prioBoardingLinkHandler
  }))), shouldShowRecheckNote && (firstItem === null || firstItem === void 0 ? void 0 : firstItem.category) === "holdBag" && isChecked && _ref10);
};
