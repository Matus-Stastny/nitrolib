...
})(["display:flex;width:100%;flex-direction:column;flex-wrap:nowrap;flex-grow:1;flex-shrink:1;justify-content:flex-start;align-content:center;> *{margin-right:", ";}"], function (_ref) {
...
var OptionItem = function OptionItem(_ref7) {
  ...
  var getFirstItemInfo = function getFirstItemInfo(isCurrent, priceValue) {
    return isCurrent ? _ref9 : React.createElement(_Text.default, {
      element: "span",
      weight: "bold"
  ...
  return React.createElement(_Stack.default, {
    ...
    shrink: true,
    spacing: "condensed"
  }, React.createElement(IconWrapper, null, (0, _utils.getIconFromCategory)(category, "medium", "primary")), React.createElement(TitleWrapper, null, React.createElement(_Text.default, null, React.createElement(Title, null, amount > 1 && React.createElement(_Text.default, {
    element: "span",
    weight: "bold"
  }, "".concat(amount, "\xD7 ")), category === "holdBag" && "".concat(restrictions.weight, "kg"), " ", (0, _utils.getTextFromCategory)(category, function (x) {
    return x.toLowerCase();
  }))), React.createElement(BaggageSizeText, {
    isMobile: true
  }, getBaggageSize(restrictions)))), React.createElement(BaggageInfoWrapper, null, React.createElement(BaggageSizeText, null, getBaggageSize(restrictions)), isFirstItem && getFirstItemInfo(isCurrentCombination, price.amount)));
};
