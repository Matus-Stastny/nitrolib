...
})(["padding:17px 0px 17px 28px;> *{margin-bottom:", ";}"], function (_ref) {
...
var ContactUsText = _styledComponents.default.p.attrs({
...
var Content = function Content(_ref10) {
  ...
  return React.createElement(Wrapper, null, definitions && definitions.map(function (bag, index) {
  ...
  }), !hasPersonalItem && _ref11, orderStatus === "notAvailable" && React.createElement(ContactUsText, null, React.createElement(_index.default, {
