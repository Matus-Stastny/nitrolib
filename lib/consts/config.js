...
var config = {
  ...
  contentTeamImagesUrl: "https://googledrive.com/host/0B6NowGirW9poflZ3RlVHa1dGSlRjdHAxenZUdWZiazFFSGNNajZVUXdSVERXNWs5T0p0aEE/",
  facebook: "kiwicom247",
  ...
  mozioEnabledLangs: ["en-US", "en-GB", "af-ZA", "zh-CN", "zh-TW", "cs-CZ", "hr-HR", "da-DK", "nl-NL", "fi-FI", "fr-FR", "de-DE", "el-GR", "id-ID", "it-IT", "ja-JP", "lt-LT", "lv-LV", "ms-MY", "no-NO", "pl-PL", "pt-PT", "ro-RO", "ru-RU", "es-ES", "sv-SE", "tl-PH", "th-TH", "tr-TR", "uk-UA", "vi-VN"],
  parkcloudEnabledLangs: ["en-GB", "cs-CZ", "de-DE", "es-ES", "fr-FR", "hu-HU", "it-IT", "lt-LT", "nl-NL", "pl-PL", "pt-PT", "ro-RO", "ru-RU", "tr-TR"],
  ...
  servicesSeatingAllowed: ["5J", "AK", "FD", "QZ", "D7", "PQ", "Z2", "I5", "XJ", "XT", "DP", "DY", "D8", "FR", "NK", "TZ", "U2", "U0", "W6", "XW", "Y4", "ZB", "F9", "JQ", "PC", "VY"],
  servicesMealsDisallowed: ["FR", "W6", "U2", "VY", "NK", "F9", "TO", "SU", "FC", "IB", "4O", "UA", "EI", "HV", "PS", "AF", "0B", "ZB", "AZ", "Y4", "DP", "BE", "AB", "DL", "AA"],
  maxSearchMonths: "9",
  ...
  feedbackAvailableLanguage: ["cz", "de", "at", "ch", "en", "au", "ca", "ee", "hk", "in", "ie", "my", "nz", "ph", "sg", "za", "us", "es", "ag", "co", "ec", "cl", "mx", "pe", "fr", "be", "ca-fr", "it", "pl", "pt", "br", "sk", "ru", "by", "kz", "uk", "ar", "ko", "ja", "bh", "jo", "kw", "om", "qa"],
